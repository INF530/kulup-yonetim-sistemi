                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <div class="card-body">
                                    <img src="https://lh5.googleusercontent.com/LuEPm_mkrHE1YHSJZaphnAdKhqDpxC4iZqhFWoYK7EzXKV7u4N67BWzm2ahkkPYjsoFhV6ycSQwsIBdCw21dsmiVjc9AsQSfVni0lFfYCn24GeDZkCzc=w1280"
                                         alt="" class="img-fluid">
                                    <p class="card-text"></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                <img src="https://lh3.googleusercontent.com/kF6AFwnMKGRymFwVBYcvrNAWfqjEOddtE_WhGZd8MShcGdUBj77ZhD6_Rk1eUW8TlAsHDg"
                                     alt="" class="img-fluid">
                                <div class="card-body">
                                    <p class="card-text"></p>
                                    <div class="d-flex justify-content-between align-items-center">
